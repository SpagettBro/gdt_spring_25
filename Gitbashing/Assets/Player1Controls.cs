...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Player1Controls.inputactions".
/// </summary>
/// <remarks>
...
public partial class @Player1Controls: IInputActionCollection2, IDisposable
{
    ...
    ~@Player1Controls()
    {
        UnityEngine.Debug.Assert(!m_Controls.enabled, "This will cause a leak and performance issues, Player1Controls.Controls.Disable() has not been called.");
    }
