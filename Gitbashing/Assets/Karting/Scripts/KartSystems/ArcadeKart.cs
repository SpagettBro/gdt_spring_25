...
namespace KartGame.KartSystems
{
    public class ArcadeKart : MonoBehaviour
    {
        ...
        public Input_Values Input = new Input_Values();
        ...
        void GatherInputs()
        {
            ...
            Input.Accelerate = Movement.y > 0;
            Input.Brake = Movement.y < 0;
            Input.TurnInput = Movement.x;
            Input.Drift = DriftAction.action.ReadValue<float>() > 0;
            WantsToDrift = Input.Drift;
        }
